...
export const DASHBOARD_ACTIONS = [
	{ id: 'vault-check', label: '知识库检查', group: 'internal', comingSoon: false },
	{ id: 'rss', label: '刷新外部消息', group: 'external', comingSoon: false },
	{ id: 'my-ai', label: 'AI 临时对话', group: 'ai', comingSoon: false },
	{ id: 'deep-research', label: '深度研究', group: 'ai', comingSoon: false },
] as const;
